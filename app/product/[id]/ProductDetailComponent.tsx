...
export default function ProductDetailComponent({
    ...
    // Hydration fix for random number
    useEffect(() => {
        setViewersNow(Math.floor(Math.random() * 40) + 15);
    }, []);
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {viewersNow > 0 && (
                                <span className="text-xs bg-neon-pink/10 text-neon-pink px-3 py-1.5 rounded-full font-semibold animate-pulse">
